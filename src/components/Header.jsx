  ...
  return (
    <div className="sticky top-0 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-white dark:bg-black">
      ...
      <div className="flex h-5 items-center">
        {pageName !== "video" && (
          <div
            className="flex md:hidden md:mr-6 text-2xl cursor-pointer items-center justify-center h-10 w-10 rounded-full hover:bg-[#303030]/[0.6]"
      ...
      <div className="group flex items-center">
        <div className="flex h-8 md:h-10 md:pl-5 border border-[#303030] rounded-l-3xl group-focus-within:border-blue-500 group-focus-within:ml-5 group-focus-within:pl-0">
